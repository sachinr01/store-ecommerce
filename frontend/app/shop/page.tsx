...
export default function ShopPage() {
  ...
  return (
    <>
      ...
      {/* ── Breadcrumb ── */}
      <nav className="csp-breadcrumb">
        <Link href="/">Home</Link>
        <span className="csp-bsep">›</span>
        <span>Shop</span>
      </nav>

      {/* ── Page header ── */}
      <div className="csp-page-header">
        <h1 className="csp-page-title">Our Collection</h1>
        <p className="csp-page-sub">Coastal-inspired gear for every adventure</p>
      </div>
      ...
      <div className="csp-body">
        ...
        {/* Sidebar */}
        <aside className={`csp-sidebar${sidebarOpen ? ' open' : ''}`}>
        ...
        <main className="csp-main">
          ...
          {/* Grid / List */}
          {!loading && !error && sorted.length > 0 && (
            <div ref={gridRef} className={`csp-grid${viewMode === 'list' ? ' list-mode' : ''}`}>
